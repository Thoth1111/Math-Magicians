...
**Math-Magicians** is a project to develop a React application. It is a Single page App (SPA) that allows users to make simple calculations and read a random math-related quote.
...
- **Dynamic build of page using React**
- **Calculator**
